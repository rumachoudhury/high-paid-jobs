...
//       <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] items-start my-6 gap-6 lg:gap-10">
//         {/* Left Cards */}
...
//             className={`cursor-pointer flex items-start gap-4 p-4 rounded-2xl shadow-sm bg-white dark:bg-[#303030] transition-all duration-300 hover:shadow-lg hover:scale-105  max-w-[400px] h-[90px] ${
...
//         {/* Right Cards */}
//         <div className="bg-white dark:bg-[#303031] p-8 rounded-2xl shadow-md space-y-2 mx-auto w-full max-w-2xl border border-gray-500 dark:border-gray-300 min-h-[250px] transition-all duration-300">
...
//     "30 to 120 min interview",
//     "40 to 70 local recruiter access",
//     "Provided recording with detailed report",
//     "Salary negotiation blueprint",
//     "Probation period hacks",
//     "Help revamp the resume and tailor it for each job",
//   ];
...
//   return (
//     <section className="py-12 px-4 md:px-12 lg:px-20 bg-gray-50  dark:bg-[#212121]">
//       <h2 className="text-5xl font-bold text-center mb-2">
//         Choose Your Path to Land Your Dream Job
//       </h2>
//       <p className="text-center text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
...
//       {/* Cards Section */}
//       <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] items-start my-6 gap-2 lg:gap-2">
//         {/* Left Side */}
...
//               icon: "/job-assessment.png",
//             },
//             {
//               key: "placement",
//               label: "Job Placement",
//               icon: "/job-placement.icon.png",
//             },
//             {
//               key: "prep",
//               label: "Job Prep",
...
//               className={`cursor-pointer flex items-start gap-4 p-4 rounded-2xl shadow-sm bg-white dark:bg-[#303030] transition-all duration-300 hover:shadow-lg hover:scale-105 max-w-[600px] h-[80px] ${
//                 selected === key || hoveredCard === key
